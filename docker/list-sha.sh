...
SHA256_LINUX_ARM=$(http --download https://github.com/kolja/orca/releases/download/${VERSION}/orca-aarch64-unknown-linux-musl.tar.gz -o - 2>/dev/null | sha256 | awk '{print $1}')
...
echo "SHA256_LINUX_ARM = \"${SHA256_LINUX_ARM}\""
